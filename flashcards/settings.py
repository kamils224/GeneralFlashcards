...
SECRET_KEY = '09+xbf7epr_$(_8@@=r(eoq8*ov@7rd2z#hwxqyt)^h(9^gh%5'
...
INSTALLED_APPS = [
    ...
    'flashcards_site.apps.FlashcardsSiteConfig',
...
LOGIN_REDIRECT_URL = 'flashcards_site:index'
LOGOUT_REDIRECT_URL = 'flashcards_site:index'
